...
nebulae compose-ui development --shell-type=FUSE2_ANGULAR --shell-repo=https://gitlab.com/git_repo_directory_path/emi --frontend-id=frontendid --output-dir=frontendid  --setup-file=../etc/mfe-setup.json
